...
export default function AdminDashboard() {
  ...
  // Add this helper function to group your fetches
  ...
  useEffect(() => {
    fetchAdminProfile(); // Usually only need to fetch profile once
  }, []); // Profile stays static

  // This effect runs every time the user switches tabs
  useEffect(() => {
    if (activeTab === "Dashboard") {
      refreshDashboardData();
    }
  }, [activeTab]); // <--- Adding activeTab here is the key
